...
label start:
    ...
    #show ager at midleft2
    #show jones at midright2
    #with dissolve
    #hide all
    #show charles at midcenter3 with dissolve
    cf "Two more days."
    show richard look at midcenter3
    with dissolve
    ...
    ish "I.."
    show ishmam normal at midright3
    ish "He said \"Thank you.\""
    ish "And that..{w} we remind him of his sons..."
    king "..."
    ...
    cole "Hey! Can you open the gates? They're locked."
    ...
    cole "What do you mean state your business? {w}I work here."
    cole "We're back from the school trip to Felsted front."
    ...
    jones "We can't go to Bedford bog now!{w} It's.."
    jones "It's far too dangerous."
    ...
    #change scene to aerial view students maybe with actual minibus
    scene bg kegsabove with fade
    ...
    "Jai" "!"
    stm "Hold it!"
    "Jai" "Quickly, I think I can make it!"
    stm "Enough."
    ...
    ish "It's been hours since we've left."
    show ishmam frown at midright3 
    ish "..."
    ish "Don't fool yourself."
    ish "If we've been driving for 6 hours.."
    rich "That's longer than the geography trip drive up to the Lake district!"
    paarth "The Peak district even."
    stop music fadeout 2.0
    ...
    narrator "The bog stretches out before them. An expanse of swaying reeds dead trees jutted out from the blackened mud, its roots like skeletal fingers."
    ...
    paarth "I guess this is why they didn't let us go too far during the cross countries."
    ...
    show ishmam normal at midright3
    ish "I didn't realise Bedford Bog continued so far."
    rich "We only ever went to the edge closest to the school."
    king "Yeah. No way they would have sent us cross country here all the time if we had to drive for this long. I'm pooped."
    ish "Just as we were going home.."
    rich "We can't give up.{w} We've survived Felsted front of all places after all."
    narrator "He chuckles."
    rich "I suppose we should explore, the others have already run off ahead."
    king "Right."
    ...
    rich "What are the teachers doing I wonder?"
    ish "We're completely in the dark."
    ...
    ish "What are you doing?! You can't just eat things in the wild. It could be poisonous!"
    rich "Eh.. I'll live. It tastes alright.. I have a strong constitution either way."
    rich "They're not mushrooms. No need for such a reaction."
    narrator "Ishmam begins to calm down. As a medicine student, wild foods were explicitly off the menu by what he thought was common sense."
    hide ishmam
    hide richard
    with dissolve
    ...
    rich "We should probably set up camp here. We don't have too much time."
    ish "Right."
    ...
    paarth "From the clearing, we went south, so.."
    ...
    paarth "Hell if I know. But my sense of direction generally tends to be true."
    ...
    narrator "Richard stepped forward, forcing the unease from his body."
    narrator "He exhaled through his nose, slow. His brow furrowed. His voice cut through the atmosphere."
    rich "We won't rely on this alone."  
    rich "We’ll need to find our own food. That goes without saying."
    narrator "The crowd quietened. They hadn't seen Richard like this before until now. His tone had weight, heavier, impactful."
    narrator "A bead of sweat ran down Richard's head."
    ...
    narrator "Richard caught his breath. His blood flowed hot through his veins as he picked up the lead of the students."
    narrator "But he couldn't shake the feeling. {w}Why was he so awkward.{w} Why was his \"leadership\" simply stating the current situation?{w} Why couldn't he bring himself to ask them:"
    rich "What went so wrong?.."

    scene bg bush with fade
    #play sound morning

    narrator "*Footsteps*"
    narrator "Frederick stepped at a sluggish pace, the distance turning his brisk walk to a stuttering stop."
    narrator "He looks worryingly overhead now"
    narrator "The time was passing and the clouds scurried along, determined to steal away the little sun that they had."
    narrator "It had been hours since the minibus had left after the teachers had arrived."
    ...
    ff "What.."
    narrator "On the ground ahead of him, someone sat hunched on the ground."
    ...
    laksh "There's no way for us to try and work out the way home.{w} The bog extends for hours this way too."
    laksh "Haaaaa..."
    ...
    ff "With who?"
    laksh "People on the inside. Verona is the last place standing for the students."
    ff "What on Earth happened? Why Verona and not just any old student?"
    laksh "..."
    laksh "Don't freak out on me but..{w} Mr Carter is no longer headteacher."
    ff "!!"
    ...
    ff "Better than Mr Maxwell-Lyte's ai posters I guess."
    laksh "...{w}bruh"
    ...
    narrator "Since yesterday morning they had distributed the supplies and built multiple shelters using tent tarp that would help keep the worst of the wind and rain out."
    #show richard
    rich "Hey Ishmam."
    #show ishmam 
    ...
    rich "We still haven't properly treated him beyond the bandage and packing the wound."
    ...
    scene bg sewerevening with fade
    ...
    narrator "Lakshya sits, cross legged, de-thorning the handle of a stick which turns to thorned brambles halfway along."
    ...
    ff "True.{w} But the thorns provide no advantage whatsoever."
    ...
    ff "Mm."
    #woods
    narrator "Frederick walks away into the woods, looking for a long straight stick."
    ...
    laksh "Let's make the most of the day. We need not worry too much about not thoroughly combing the area since we'll do another pass on the way back."
    sam "Mm right."
    ...
    narrator "Frederick's elbow was jammed into Lakshya's ribs and he tried to reposition."
    laksh "Don't move."
    ...
    narrator "Sam held his face in his hands, struggling to not breathe through his nose or mouth."
    narrator "But through tears, he watched it.{w} The cow."
    narrator "Its head hung low as it stepped out of the trees next to them."
    sam "What on earth happened to you?"
    narrator "Its hide sagged, stretched thin and translucent next to yellow and white skin that oozed pus."
    narrator "Cris-crossed around its dark patches, blue veins visible on raw skin, hairless."
    ...
    narrator "Johnathon's realised his face was wet. Not from the tears from the pungent smell but sweat, cold as ice."
    ...
    narrator "Frederick and Sam wait in the clearing, awaiting their return."
    ...
    narrator "He doubles back on himself, checking if he missed something. Anything."
    best "Ajay?"
    ...
    best "It's over."
    best "Those clothes.. Nothing good could have ever been behind that."
    ...
    best "No luck I'm guessing."
    laksh "No.."
    laksh "I'm sorry."
    laksh "We know how much you care about him."
    ff "You're best buds."
    ff "And there was a chance, however slim it was if you think about it."
    best "Right, yeah. Uh."
    best "Sorry."
    laksh "..."
    ...
    best "What?!"
    narrator "Lakshya is somewhat shocked by Johnathon's sudden aggression."
    ...
    laksh "This forest, this bog.. {w}There's something seriously wrong with it."
    ...
    ff "You know.."
    best ".."
    best "Perhaps with how much time has passed{w} There's a fair chance that we could find them on the way back."
    narrator "He tries his hardest to convince himself."
    best "Like the likelihood is pretty similar no matter which direction we take."
    ff "Right. Yeah."
    narrator "He looks up worryingly at the sky."
    ff "I wouldn't count on it though."
    narrator "They begin the return journey in near silence."
    narrator "Hours of walking had sucked the energy and fun out of exploring."
    narrator "The grim atmosphere sets in and the forest seems quieter now."
    sam "It feels different, walking back."
    sam "We're not exploring this place. I just feel guilty."
    laksh "Yeah."
    ff "You think every search party is like this."
    ff "The walk home.{w} The heavy feeling in your stomach."
    best "..."
    narrator "Johnathon says nothing. His eyes scan every tree, every shadow, as if Ajay could be round any corner."
    narrator "As if it hinged on his shoulders alone. That he would find him."
    #branch snaps
    ff "!"
    narrator "He stops and holds his fist up."
    narrator "They freeze."
    narrator "Something moved ahead of them, slow and deliberate."
    best "- .."
    narrator "Johnathon looked up from where he crouched in the dark."
    "??" ".."
    narrator "It rustled in the bush beside them."
    narrator "Lakshya turned, stick in hand."
    laksh "Over here. Keep your distance."
    narrator "The party is in a quiet panic, freezing before the unseen foe."
    narrator "Freddie snatches the stick from Lakshya and slowly approaches the bush."
    laksh "Careful Freddie, it could be anything."
    "??" "Freddie?..{w} Lakshya? You're here too?"
    narrator "It steps out of the bushes into view."
    cf "What are you lot doing here? Are you lost too?"
    narrator "He props up his spear, a large straight stick sharpened to a vicious point with a barb protruding out the side."
    ff "Charles!?"
    narrator "He runs forward, grabbing his wrist."
    ff "We're the search party, sent to find everyone who went lost in the woods."
    cf "Oh sick? Who have you found so far?"
    ff "We found Sam near the beginning and now we've found you!"
    laksh "We're on our way back now, honestly was afraid that this would be all we got."
    laksh "But hey, we got both of the Fenton-Tuns now for what it's worht!"
    cf "That's alright then. Sorry, I don't know where anyone else is though.."
    cf "After that first night.."
    narrator "He speaks grimly."
    best "What happened?"
    cf "A while after we entered the forest we got terrifically lost. We tried to backtrack but we kept finding new areas we'd never seen before."
    cf "Walking past clearings that we'd never set foot in before."
    cf "We split apart, looking in every direction as it was turning evening."
    cf "That's was when we were attacked by the huge boar."
    #legs
    cf "This huge mass of muscle and mass."
    cf "It thundered through the trees and we didn't have time to regroup."
    cf "Splintered apart, we were easy pickings for the creatures through the night."
    cf "I don't know who, if anyone made it out, else I wouldn't be walking alone."
    sam "..The beast"
    cf "Come."
    narrator "He beckoned them. His sombre tone conveyed the gravity of his request."
    narrator "They moved silently before shortly coming to a stop."
    narrator "There, not far from where they stood with Charles, a strange rock stood alone."
    narrator "It seemed darker than the light that fell upon it, its shadow moving and restless."
    narrator "The smell was unbearable."
    laksh "That..cow.. has been through here.."
    best "No. It's not.."
    narrator "Lakshya held his sleeve to his mouth, smothering the smell."
    cf "Don't walk through these woods with but your two feet."
    narrator "He looks upon the gore with regretful eyes."
    cf "When you are alone, when we are few."
    cf "We will suffer.{w} We will die.{w} Alone."
    cf "And we will keep dying."
    sam "......!.."
    narrator "Sam turned away, unable to keep looking. The taste of chestnut in the back of his throat, nauseous."
    best "I can't believe it.{w} It feels so surreal"
    laksh ".."
    laksh "Who was it?.."
    cf "...."
    cf "I don't know. They weren't with me."
    laksh "The clothes are ripped to shreds. No work organiser or anything with their name on. It could be anyone."
    best "I'm sorry."
    #shake
    best "I'm sorry. I'm sorry."
    narrator "Tears are running down his face, flooding."
    laksh "Johnathon?  Are you okay? It could be anyone."
    best "No! It doesn't matter!"
    best "Even if it wasn't Ajay!{w} It could be!"
    narrator "The words spill out before he realise's he's spoken."
    best "It doesn't matter."
    narrator "Everyone goes still. He's sobbing louder."
    best "It doesn't matter if it's him or not."
    best "Because it *could* be."
    narrator "A laugh slips out of him - sharp, shrill."
    narrator "Broken."
    best "I loved you.{w} I loved him."
    best "But nobody could have known."
    best "Nobody knew us like me."
    cf "..."
    narrator "Johnathon tears his eyes off the body."
    best "Nobody could know of our joy. You were taken too soon."
    best "This cruel world."
    narrator "The tears stop.{w} Not because of his sorrow but because he has nothing left to give."
    narrator "They haven't drank since yesterday."
    cf "I.."
    narrator "He motions to try and comfort him."
    laksh "Don't.."
    cf ".."
    narrator "Johnathon wipes his face with a filthy sleeve."
    narrator "His eyes are red.{w} Dry."
    narrator "Something in him has gone quiet.{w} Older."
    best "This cruel world.."
    narrator "He turns to the others."
    best "We should go."
    narrator "The others are silent for a moment."
    cf "You know the way, I hope?"
    narrator "Lakshya nudges Frederick."
    laksh "He does."
    ff "Mhm. Got it all down on the map."
    ff ".."
    narrator "They walk. In lucid silence."
    #change scene
    narrator "The trees thicken and thin as they trudge through the forest, retracing their steps."
    narrator "Aside from adjusting their direction and a few failed attempts to make conversation, all one could hear were footsteps in grass."
    narrator "Finally they emerge from the trees."
    ff "The sewage pipe should be here."
    laksh "Looks about right."
    best "Let's set up here."
    narrator "The others watch Johnathon continue onwards in concerned silence."
    laksh "We already have the startings of a fire here already so I'll start trying to light it already while you find some more fuel."
    narrator "In no time at all, their practiced movements build the fire and they wait, chewing on more chestnuts and a few berries they found while forging."
    ff "I hope Richard are the others have a good base going."
    cf "Hah...., you make it sound like Minecraft."
    laksh "Stone tools would be nice, my uh.. wooden sword kinda sucks."
    cf "You should sharpen it to a point like I have."
    laksh "Yeah I would have if I had my knife. They took mine when we were in the minibus to here."
    sam "You had a knife?!"
    laksh "I did.. fat lot of use it was, losing it immediately."
    best "Sam, we're going."
    sam "Alright."
    scene bg sewernight with fade
    narrator "Beside the fire, the water trickling from the sewer pops."
    narrator "Fat coats the water. Barely reflecting the moon and stars above."
    #scene dead body
    narrator "They lay down and try to sleep, despite the body{w}, despite those empty, folded clothes."
    narrator "It's empty sockets haunting."
    narrator "That was one of us."
    narrator "They were.."
    scene bg sewernight #no fade
    laksh "!.."
    narrator "Lakshya awoke all of a sudden."
    laksh "What?"
    narrator "There was a strange glow among the trees."
    laksh "Sam! Charles!"
    narrator "He quietly awakens the others and watches the light through the trees."
    ff "You think they're already looking for us?"
    laksh "No that makes no sense."
    cf "A beast.."
    laksh "Something's out there."
    best "I'm going to take a look."
    cf "Huh? Wha.."
    narrator "But he was already clambering out of the ditch."
    cf "No, you can't! It's not safe to go. Not alone."
    narrator "He hurries after Johnathon. Freddie follows him."
    narrator "Together they follow the light into the woods. Lakshya and Sam watch from the ditch by the sewer."
    cf ".."
    narrator "He holds his fist up, indicating to stop."
    cf "I can hear it."
    narrator "Footsteps thud upon the earth lightly."
    cf "Two pairs of footsteps.{w} I guess it's probably people."
    ff "!"
    best "Really? Remarkable."
    narrator "Johnathon looks at him curiously but not, as Charles noted, with the desperate passion he had before."
    cf "Shall we approach?"
    best "If it's people out to find us, or someone else, it's probably a good thing right?"
    ff "Mhm."
    ...
    ager "Charles?"
    narrator "His hand quickly reaches to his hip but relaxes when he sees the two others."
    ff "Mr Cole! Mr Ager?! What are you doing here?"
    ager "What are you doing out here? We're uh.."
    narrator "He turns to Mr Cole."
    cole "We were out uh.. looking for you."
    ff "We were the search party, we were on our way back."
    ager "Ah, do you need any help getting back then?"
    narrator "He recomposes himself and holds his slim hands together."
    ff "No."
    cf "Well, do you know where the base is right now?"
    ager "Ah, we can take you. No worries."
    ager "That was what we came here for."
    best "Okay, best get the others then."
    ager "But of course, let's make haste."
    narrator "They walk shortly back to the sewer ditch. Mr Ager talks pleasantly but Mr Cole is silent."
    laksh "Oh my goodness. Sam."
    sam "What?"
    laksh "It's the teachers! Mr Cole and Mr Ager."
    sam "We're finally out of here."
    narrator "He breathes, relieved."
    narrator "They run out of the sewer ditch"
    laksh "Mr Ager. Mr Cole..."
    narrator "He eyes them carefully."
    ager "?"
    laksh "Hmph. Lets go."
    ...
    friel "Just a moment, we'll start once the last people come."
    rich "..."
    narrator "The students bumble shortly as everyone gathers. The teachers stand patiently."
    jones "Alright, I think that's about all."
    jones "I'm sure you all know that a number of us are missing in the forest."
    jones "There have been many rumours about what's in the forest.{w} While I don't believe there is anything there -"
    jones "It's safe to be cautious."
    friel "We need to find the rest of the missing students.{w} The search party yesterday managed to find 2 people lost in the forest."
    friel "But this took 3 days."
    jones "Right."
    jones "What we're saying is{w}, we need another expedition."
    jones "We need landmarks, ways to find your way.{w} A map.{w} Like the one Freddie has started."
    ff ".."
    jones "We do this in the hope we'll find something. Who knows? There may be fields of food or more buildings like the one we live in."
    friel "We managed to convince Mr Seed to send us care packages very occasionally to get us by."
    friel "But generally, the situation is very dire.{w} We are making do with nothing."
    friel "We need students who can explore the land further."
    narrator "She looks at the students."
    king "I see why they wanted to tell us this all together."
    rich "I suppose the search party from earlier would make a good fit."
    jones "Yeah, in a sense this is a continuation of the former search party."
    jones "Although a few more people would be ideal."
    rich "It would be best if we gave them the packaged food from our supplies."
    friel "Naturally."
    narrator "Ms Jones looks quizzically at Mrs Friel for a second before her face softens again."
    jones "Uh yeah."
    narrator "The new search party was formed.{w} Johnathon Best, Charles and Frederick Fenton Tun of the previous group were now joined by Dharan and Kingshuk."
    narrator "The meeting disperses and the students wander off back to their tents."
    narrator "Dharan shifts his feet in his shoes and looks down.{w} He signed up for this, but he knew what he saw in the woods."
    dharan "Um..{w} I"
    king "Don't think too much about it. A few days is a long time but it's no different than a few days spent here in the open field."
    narrator "Dharan smiles weakly."
    dharan "Yeah.. Let's pack then."
    narrator "Charles walks carefully by the storage tent."
    cf "Hmph."
    narrator "He remarks about nothing as he eyes the old blue building and then glances out at the field where he sees Ms Jones and Mrs Friel."
    cf "Now, where would Mr Cole and Mr Ager be then?"
    narrator "He walks across to the building inconspicuously, finally knocking on the door."
    cf "..."
    cf "Nobody's home?"
    narrator "He knocks again to make sure."
    cf "..."
    narrator "He contemplates for a second, grinding his foot in the exposed soil before the small building."
    cf "Why would they all try to cram into here? The tents aren't that bad."
    cf "In fact it only provides better shelter from the wind and rain."
    narrator "He turns, looking over his shoulder at the food tent."
    cf "Why..?"
    narrator "His brow furrows as he trails off."
    cf "The Beast.."
    #open door creak
    narrator "He slowly opens the door, his heart in his throat, anticipating a scolding."
    cf "..."
    cf "hah.."
    narrator "No one is home."
    cf "It's not quite as stuffed as I thought it would be in here."
    cf ".."
    cf "There's only 2 beds."
    narrator "He scans the room, finding nothing."
    cf "Maybe they cleared their sleeping bags away?"
    narrator "He makes a quizzical face."
    cf "..."
    narrator "He picks his way through the messy room."
    narrator "Old cobwebs remain in places, mostly cleared away when the teachers moved in."
    narrator "A large rack stands at the end of the room, stacked with a number of black plastic containers."
    cf "They have power here. Damn."
    narrator "He plugs his phone in, ensuring it remains off. If he could try get signal out here, he may be able to get help from his parents."
    cf "Wonder what they're doing."
    cf "They probably still think I'm at Felsted front."
    cf "Imagine I call and they think its a ghost. Hehe."
    narrator "He grins as he pokes around some of the boxes and large cabling."
    narrator "He fiddles with an iron fence gate latch as he peers in a box under the shelf."
    narrator "He stops for a moment, digging in the box."
    cf "Hmm?"
    narrator "Amongst the carefully laid out items in the container, he hears the light clink of metal as he rummages."
    narrator "He searches the little card packages, until opening a packet of cigarettes."
    cf "Nobody smokes here. And they're opened too."
    narrator "He goes quiet, looking behind him at the door."
    cf "There's a number more of these cigarette packs."
    cf ".."
    cf "They can't be from Felsted front.{w} It never would have made it through airport security."
    narrator "They clinked inside the cigarette pack as he gripped them harder."
    narrator "He slips one out of the pack, inspecting it carefully now."
    cf "A bullet."
    cf "A rifle one at that."
    cf ".."
    cf "The Beast."
    narrator "He stands up carefully from where he knelt earlier, listening carefully that nobody was nearby."
    narrator "Before he leaves, he turns and takes the fence bolt."
    cf "I have a bad feeling about this whole arrangement."
    cf "If they have guns on them, then surely.."
    cf ".."
    cf "What are we doing then..?"
