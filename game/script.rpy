...
label start:
    ...
    laksh "Johnathon."
    best "What have you found?"
    laksh "Come look. I havent touched it."
    narrator "Johnathon hurries over."
    best "What is it, the suspense is kilin.. Oh."
    narrator "Within the crop of trees, clothes folded neatly on the ground."
    narrator "Lakshya looks away, to Freddie."
    best "You think they're still around here?"
    laksh "Surely, no?"
    label "Hard to take off without your underwear right."
    best "Right...."
    narrator "He steps closer towards the clothes, and rummages within the blazer pocket before producing a work organiser."
    laksh "Let's see..{w} Ajay Aranraj, 9A."
    best "!"
    ...
    best "Yeah what?.."
    laksh "I doubt he's running around the woods like Tarzan."
    ...
    narrator "He props up his spear, a large straight stick sharpened to a vicious point with a barb protuding out the side."
    ff "Charles!?"
    ...
    cf "That's alright then. Sorry that I don't know where anyone else is."
    ...
    cf "Thats was when we were attacked by the huge boar."
    #legs
    ...
    narrator "They moved silently before shortly comign to a stop."
    ...
    laksh "The blazer is ripped to shreds. No work organiser or anything with their name on. It could be anyone."
    best "I'm sorry."
    #shake
    ...
    narrator "Lakshya nudges Fredderick."
    laksh "He does."
    ...
    narrator "In no time at all, their practiced movements build the fire and they wait, chewing on more chestnuts and a few berries they found while forraging."
    ...
    narrator "They were.."
    laksh "!.."
    narrator "Lakshya awoke slowly."
    #still night
    laksh "What?"
    narrator "There was a strange glow among the trees."
    laksh "Sam! Charles!"
    narrator "He quietly awkens the others and watches the light through the trees."
    ...
    narrator "Johnathon looks at him curiously but not, as Charles noted, with the desparate passion he had before."
    ...
    cole "We were out uh.. looking for you. Yes."
    ...
    ager "That was uh.. what we came here for."
